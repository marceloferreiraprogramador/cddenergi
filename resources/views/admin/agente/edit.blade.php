...
<div class="col-md-12">
    <div class="box box-info">
        <div class="box-header with-border">
            <h3 class="box-title">Editar Fornecedor <b>{{ $agentes->name }}</b> </h3>
        </div>
        <form action="{{ route('agente.update', ['agentes' => $agentes->id] ) }}" class="form-horizontal"  method="POST">
                {{ csrf_field() }}
                @include('admin.agente._formedit')
